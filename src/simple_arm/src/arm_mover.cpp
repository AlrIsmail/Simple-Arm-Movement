...
public:
    MoveArm()
    {
        ...
        service = n.advertiseService("/arm_mover/safe_move", &MoveArm::handle_safe_move_request, this);
...
int main(int argc, char** argv)
{
    ...
    // Create an object of class MoveArm that will take care of everything
    MoveArm moveArm;
